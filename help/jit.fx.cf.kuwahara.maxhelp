...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 500.0, 56.0, 640.0, 360.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 45.0, 483.0, 157.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 82.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
,
					...
					"output_texture" : 1,
					"parameter_enable" : 0,
					"patching_rect" : [ 45.0, 106.0, 420.0, 41.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 45.0, 157.0, 216.0, 22.0 ],
					"text" : "jit.gl.slab @dimscale 0.5 0.5 @inputs 1",
					"textfile" : 					{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 93.0, 303.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 93.0, 274.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"filename" : "jit.fx.cf.kuwahara.js",
					"id" : "obj-1",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 45.0, 394.0, 98.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 93.0, 242.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 93.0, 335.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 93.0, 212.0, 150.0, 22.0 ]
				}
